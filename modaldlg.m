...
% Last Modified by GUIDE v2.5 24-Jul-2016 14:21:42
...
% --- Executes on button press in contBtn.
function contBtn_Callback(hObject, eventdata, handles)
% hObject    handle to contBtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
